...
public class EstNerResultDto {
  ...
  public EstNerResultDto per(List<String> per) {
    this.per = per;
    return this;
  }

  public EstNerResultDto addPerItem(String perItem) {
    if (this.per == null) {
  ...
  **/
  ...
  public EstNerResultDto org(List<String> org) {
    this.org = org;
    return this;
  }

  public EstNerResultDto addOrgItem(String orgItem) {
    if (this.org == null) {
  ...
  **/
  ...
  public EstNerResultDto loc(List<String> loc) {
    this.loc = loc;
    return this;
  }

  public EstNerResultDto addLocItem(String locItem) {
    if (this.loc == null) {
  ...
  **/
  ...
  public EstNerResultDto start(String start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public EstNerResultDto end(String end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EstNerResultDto estNerResultDto = (EstNerResultDto) o;
    return Objects.equals(this.per, estNerResultDto.per) &&
        Objects.equals(this.org, estNerResultDto.org) &&
        Objects.equals(this.loc, estNerResultDto.loc) &&
        Objects.equals(this.start, estNerResultDto.start) &&
        Objects.equals(this.end, estNerResultDto.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class EstNerResultDto {\n");
